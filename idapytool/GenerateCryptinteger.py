...
FLOAT2_ENCRYPT_PATTERN = "89 45 F8 8A 18 8D 45 FF "
FLOAT2_CRYPTSTART_PATTERN = "8B 4E 04"
FLOAT2_CRYPTEND_PATTERN = "88 5D FF"
FLOAT2_PROLOGUE_PATTERN = "8B FF 55 8b ec"
FLOAT2_EPILOGUE_PATTERN = "c3 68 ? ? ? ? e8 ? ? ? ?"
...
ScanFunctions("FLOAT", FLOAT2_ENCRYPT_PATTERN, FLOAT2_PROLOGUE_PATTERN, FLOAT2_EPILOGUE_PATTERN, FLOAT2_CRYPTSTART_PATTERN, FLOAT2_CRYPTEND_PATTERN)